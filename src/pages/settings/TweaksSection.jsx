...
export default function TweaksSection({ expandedSections, toggleSection, glassOpacity, setGlassOpacity, showAppLabels, setShowAppLabels, use24HourClock, setUse24HourClock, fullscreenActive, setFullscreenActive, showHomeOrb, setShowHomeOrb }) {
  return (
    <SettingsSection title="OPTICAL INTERFACE TWEAKS" icon="tune" sectionKey="tweaks" expandedSections={expandedSections} toggleSection={toggleSection}>
      <SettingSlider label="Glass Opacity" value={glassOpacity} onChange={setGlassOpacity} min="0" max="100" unit="%" />
